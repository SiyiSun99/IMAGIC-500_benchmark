...
if __name__ == "__main__":
    ...
    output_file = Path(
        "/Users/siysun/Desktop/PhD/SynthCPHS_benchmark/imputation_times_dsan_C19_synthetic.csv"
    )
    time_records = []
        ...
        for miss_method in tqdm(missing_methods):
            for miss_ratio in tqdm(missing_ratios):
                ...
                for index_file in tqdm(range(SampleTime)):
                    ...
                    # Store result
                    time_records.append(
                        [cohort, "DSAN", miss_method, miss_ratio, index_file, avg_time]
                    )
