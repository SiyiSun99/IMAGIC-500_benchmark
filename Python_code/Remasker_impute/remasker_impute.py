...
for method in tqdm(methods):
    for ratio in tqdm(ratios):
        ...
        for index_file in tqdm(range(Sampletime)):
            ...
            ## Impute train
            out_train = imputer.fit_transform(train_miss.copy())
            ...
            ## Impute test
            test_miss_tsr = torch.tensor(test_miss.copy().values, dtype=torch.float32)
            out_test = imputer.transform(test_miss_tsr)
