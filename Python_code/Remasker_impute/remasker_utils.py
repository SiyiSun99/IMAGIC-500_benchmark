...
def get_args_parser():
    ...
    parser.add_argument(
        "--embed_dim", default=32, type=int, help="embedding dimensions"
    )
    ...
    parser.add_argument(
        "--encode_func", default="linear", type=str, help="encoding function"
    )
    ...
    ###### change this path
    parser.add_argument(
        "--path", default="/data/tianyu/remasker/", type=str, help="dataset path"
    )
    ...
    parser.add_argument(
        "--overwrite", default=True, help="whether to overwrite default config"
    )
