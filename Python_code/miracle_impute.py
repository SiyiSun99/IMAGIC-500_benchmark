...
for method in tqdm(methods):
    for ratio in tqdm(ratios):
        ...
        for index_file in tqdm(range(Sampletime)):
            ...
            # train_miss = train_miss.iloc[:10000,:] # need delete, get a sample to test code
            # test_miss = test_miss.iloc[:1000,:] # need delete, get a sample to test code
